...
.form-container { background: #fff; padding: 20px; margin-top: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); }
...
<header>
  ...
  <div class="header2">
    <nav class="nav-links2">
      ...
      <a href="inventory&logistics.html"><i class="fa fa-boxes"></i> Inventory</a>
      <a href="Aid.html"><i class="fa fa-hand-holding-heart"></i> Aid</a>
      <a href="StaffDashboard.php" class="active"><i class="fa fa-user-tie"></i> Staff</a>
    </nav>
  </div>
  <div class="header3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="delete_staff.php?id=<?= $staff['staff_id'] ?>" onclick="return confirm('Delete this staff member?');" class="action-btn"><i class="fa fa-trash"></i> Delete</a>
        </td>
      </tr>
      <?php endforeach; ?>
