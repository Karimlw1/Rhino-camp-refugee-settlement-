...
$stmt = $pdo->query("SELECT * FROM refugees ORDER BY refugee_id ASC");
$refugees = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<header>
  ...
  <nav><a href="refugees_dashboard.html">&larr; Dashboard</a></nav>
</header>
